...
public class E2E_FC_IGN_003 extends BaseClass
{//========================End-to-End Full Composite - No Team Image with ‘Ignore Team Image’=======================
	...
	public void E2E_Full_Composite_with_NoTeam_IgnoreteamImage() throws Throwable 
	{
		...
		Log.startTestCase("▶️ Test Start: Full Composite with  No Team >> Ignore Teaam image ");
		...
		try {
			...
			Log.info("User selects  No Team Option with Ignore team image.");
			fc.ClickonNoTeam();
			//Thread.sleep(1000);
