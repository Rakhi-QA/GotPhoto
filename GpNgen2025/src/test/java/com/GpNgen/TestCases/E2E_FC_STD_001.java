...
public class E2E_FC_STD_001 extends BaseClass
{
	...
	{
		test = extent.createTest("🧪 Full Composite Order → Standard Team Build → 50% Discount + Save Card Payment");
		Log.startTestCase("▶️ Test Start: Full Composite with Standard Team Build");
		...
		try {
			...
			Log.info("User selects Standard Team Build.");
			fc.ClickonSTD();
			test.pass("✅ Standard Team Build option selected.");
