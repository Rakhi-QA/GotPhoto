...
import com.GpNgen.utility.APIretunJobNameCheckURL;
import com.GpNgen.utility.APIretunJobNameCheckURL.JobData;
...
public class APIpostRequest
{
	...
	public static JobData  sendCreateJobRequest() {
		String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
		String jobName = "Test_AutoJob_" + timeStamp;
		GlobalData.job_Name = jobName;
		//APIretunJobNameCheckURL rc=new APIretunJobNameCheckURL();
